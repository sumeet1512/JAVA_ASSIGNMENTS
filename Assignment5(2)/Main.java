    ...
    public static void main(String[] args) {
        ...
        switch (c)
        {
            case 1:
                ...
                System.out.println("Basic Wage: " +

                        normalEmployee.calculateBasicWage());

                System.out.println("HRA: " + normalEmployee.calculateHRA());
                System.out.println("Conveyance Allowances: " +

                        normalEmployee.calculateConveyanceAllowances());

                System.out.println("Medical Allowances: " +

                        normalEmployee.calculateMedicalAllowances());

                System.out.println("Other Allowances: " +

                        normalEmployee.calculateOtherAllowances());

                System.out.println("Total Earnings: " +

                        normalEmployee.calculateTotalEarnings());

                System.out.println("\nDeductions for Normal Employee:");
                System.out.println("EPF Deduction: " +

                        normalEmployee.calculateEPFDeduction());

                System.out.println("ESI Deduction: " +

                        normalEmployee.calculateESIDeduction());

                System.out.println("Professional Tax: " +

                        normalEmployee.calculateProfessionalTax());

                System.out.println("Loan Recovery: " +

                        normalEmployee.calculateLoanRecovery());

                System.out.println("Total Deductions: " +

                        normalEmployee.calculateTotalDeductions());
                System.out.println("\nNet Salary: "+normalEmployee.calculateNetSalary());

                break;
            case 2:
                BonusEmployee bonusEmployee = new BonusEmployee(name, uan,
                ...
                System.out.println("Basic Wage: " +
                        ...
                        bonusEmployee.calculateBasicWage());

                System.out.println("HRA: " + bonusEmployee.calculateHRA());
                System.out.println("Conveyance Allowances: " +

                        bonusEmployee.calculateConveyanceAllowances());

                System.out.println("Medical Allowances: " +

                        bonusEmployee.calculateMedicalAllowances());

                System.out.println("Other Allowances: " +

                        bonusEmployee.calculateOtherAllowances());

                System.out.println("Total Earnings: " +

                        bonusEmployee.calculateTotalEarnings());

                System.out.println("\nDeductions for Bonus Employee:");
                System.out.println("EPF Deduction: " +

                        bonusEmployee.calculateEPFDeduction());

                System.out.println("ESI Deduction: " +

                        bonusEmployee.calculateESIDeduction());

                System.out.println("Professional Tax: " +

                        bonusEmployee.calculateProfessionalTax());

                System.out.println("Loan Recovery: " +

                        bonusEmployee.calculateLoanRecovery());

                System.out.println("Total Deductions: " +

                        bonusEmployee.calculateTotalDeductions());
